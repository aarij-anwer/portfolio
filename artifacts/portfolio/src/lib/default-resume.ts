...
export const defaultResume: ParsedResume = {
  ...
  competencies: [
    ...
    {
      label: "AI in Practice (Daily)",
      value: mixed(
        plain("Force multiplier across the full SDLC, used every day. "),
        bold("Cursor + agentic coding"),
        plain(" for feature scaffolding, refactors, and codebase navigation; "),
        bold("AI-assisted code review"),
        plain(" to catch regressions before PR; "),
        bold("test generation"),
        plain(" (Jest/RTL) to lift coverage on legacy paths; "),
        bold("debugging triage"),
        plain(" of incidents and stack traces; "),
        bold("RFC and doc drafting"),
        plain(". Production experience with OpenAI, Cursor, Cleric, Mendral, and Langbase; ML foundations in TensorFlow, PyTorch, Scikit-learn."),
      ),
      icon: "generative_ai",
    },
    {
      ...
      value: mixed(
        plain("Align non-technical stakeholders, manage upwards, and partner closely with product, design, and operations. Translate ambiguous requirements into scoped deliverables, surface tradeoffs early, and communicate risk before it becomes urgent. Comfortable in "),
        bold("agile"),
        plain(" (sprints, standups, planning, retros) and "),
        bold("waterfall"),
        plain(" delivery; have led pilots, vendor demos, and post-incident reviews directly with customers and executives."),
      ),
      icon: "psychology",
    },
  ],
  experience: [
    ...
    },
    {
      ...
      bullets: [
        text("Bootstrapped and scaled two online ventures over a decade: an e-learning platform and an Amazon FBA storefront, ultimately exiting with ongoing royalty income."),
        mixed(bold("Product design and merchandising"), plain(": defined the catalog, designed packaging and listing imagery, and shaped the customer-facing brand end-to-end - acting as solo product manager, designer, and copywriter to ship a coherent line of digital and physical goods.")),
        mixed(bold("Supplier sourcing and negotiation"), plain(": qualified overseas manufacturers, negotiated unit economics and MOQs, and coordinated quality control and logistics to keep margins healthy as volume scaled.")),
        mixed(bold("Customer acquisition and retention"), plain(": ran SEO, paid acquisition, email funnels, and Amazon listing optimization to grow a global customer base; iterated on copy and creative based on conversion data to lift repeat purchase rates.")),
        mixed(bold("Content production"), plain(": authored and produced the full course library for the e-learning venture (video, written lessons, assessments), then maintained it through multiple revisions as the curriculum matured.")),
        mixed(bold("Operations and P&L"), plain(": owned inventory planning, cash flow, taxes, returns, and customer support across both ventures; turned operating discipline into a profitable steady-state that supported a successful exit.")),
        mixed(bold("Outcomes"), plain(": grew both ventures to sustainable profitability, sold the e-learning platform to a strategic acquirer with continuing royalty income, and built the systems thinking and product instincts I bring to engineering work today.")),
      ],
    },
  ],
  education: [
