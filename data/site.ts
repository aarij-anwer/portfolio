...
export const homeContent = {
  title: "Building high-performance web experiences.",
  ...
  portrait: {
    src: "https://lh3.googleusercontent.com/aida-public/AB6AXuAwlhvjgul-fGInVrEuiLTAqdpjx4BmFrrTnFHLDg4QxMau20EameFTHAUa1ex3i0QePcSmxOobgDawgI2pbvAh8uubxnb7-e5SbKb0IcPiTH6Q4l2zjA5nh7M3YjKyAYxCySQXX7cIDi5YYZEnDjth1lcd6QZeJgEEnOwKR9K9moXhS5X0EZFXgB4mqzMFvsrzCPw8w2PfVPD1ZeXbY33CwLjkij-JwuMnD2i4Yyhp7WXG8cm_2NrGHtblPBbWCmAtJZO6Jxq9bHsz",
    alt: "Professional portrait of a male software engineer with short hair wearing a dark shirt.",
  },
  competencies: [
    {
  ...
  features: [
    {
      ...
      description: "Sub-50ms latency for cross-client state synchronization using optimized WebSocket payloads.",
      icon: "bolt",
    },
    {
      title: "Event Sourcing",
      description: "Immutable audit log of all user actions to enable complex undo operations and historical analytics.",
      icon: "database",
    },
  ],
  metrics: [
...
export const resumeData = {
  ...
  competencies: [
    {
      label: "Languages",
      value: "JavaScript (ES6+), TypeScript, Python, Ruby, HTML5, CSS3, SQL",
      icon: "code",
    },
    {
      label: "Frameworks/Libraries",
      value: "React, Node.js, Express, Ruby on Rails, Django, Tailwind CSS, Redux",
      icon: "layers",
    },
    {
      label: "Databases",
      value: "PostgreSQL, MongoDB, Redis, MySQL",
      icon: "database",
    },
    {
      label: "Tools & DevSecOps",
      value: "Git, Docker, AWS (EC2, S3), Jest, RSpec, CI/CD pipelines",
      icon: "build",
    },
  ],
  experience: [
    {
      ...
      companyLine: "ESGTree | Toronto, ON | Jan 2022 – Present",
      current: true,
      bullets: [
        "Spearheaded the development of a real-time ESG data reporting dashboard using React and TypeScript, resulting in a 40% decrease in client report generation time.",
        "Designed and implemented RESTful APIs using Node.js and Express to securely handle sensitive environmental data streams.",
        "Optimized PostgreSQL database queries, reducing average load times for complex data visualizations by 1.5 seconds.",
        "Collaborated closely with product managers and UX designers to iteratively improve platform accessibility and user engagement metrics.",
      ],
    },
    {
      role: "Full Stack Developer",
      companyLine: "LaunchGood | Remote | Jun 2020 – Dec 2021",
      bullets: [
        "Contributed to the core Ruby on Rails monolith, implementing new features for campaign creation and donor management.",
        "Migrated legacy jQuery components to modern React components, improving maintainability and component reusability across the platform.",
        "Integrated third-party payment gateways (Stripe, PayPal) ensuring secure and reliable transaction processing for crowdfunding campaigns.",
      ],
    },
    {
      role: "Web Developer Intern",
      companyLine: "E-Commerce Solutions Inc. | London, ON | May 2019 – Aug 2019",
      bullets: [
        "Developed responsive front-end interfaces for custom Shopify themes using HTML, CSS, and Vanilla JavaScript.",
        "Assisted in conducting cross-browser testing and resolving UI bugs to ensure consistent user experiences.",
      ],
    },
  ...
  education: [
    {
      ...
      credential: "Web Development Bootcamp Diploma",
      details: "Toronto, ON | 2020",
    },
    {
      school: "University of Waterloo",
      credential: "Bachelor of Science, Kinesiology",
      details: "Waterloo, ON | 2014 – 2018",
    },
    {
      school: "Fanshawe College",
      credential: "Post-Graduate Certificate, Health Systems Management",
      details: "London, ON | 2018 – 2019",
    },
  ] satisfies ResumeEducation[],
  interests: ["Rock Climbing", "Open Source Contribution", "Analog Photography", "Mechanical Keyboards"],
};
