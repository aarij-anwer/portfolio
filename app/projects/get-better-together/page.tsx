      ...
      <PageContainer className="space-y-16 md:space-y-24">
        <header className="space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-[-0.04em] text-on-surface md:text-5xl">{project.title}</h1>
            <p className="max-w-2xl text-lg leading-8 text-on-surface-variant">{project.summary}</p>
          </div>
        </header>
          ...
          <div className="space-y-8 md:col-span-8">
            <SurfaceCard className="p-8">
              <h2 className="mb-6 flex items-center gap-3 text-2xl font-semibold tracking-[-0.02em] text-on-surface">
                <SymbolIcon name="architecture" className="h-6 w-6 text-primary" />
                Technical Overview
              </h2>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {project.features.map((feature) => (
                <SurfaceCard key={feature.title} className="bg-surface-container-low p-6">
                  <SymbolIcon name={feature.icon} className="mb-4 h-8 w-8 text-primary" />
                  <h3 className="mb-2 text-xl font-semibold tracking-[-0.02em] text-on-surface">{feature.title}</h3>
            ...
            <SurfaceCard className="p-8">
              <h2 className="mb-6 flex items-center gap-3 text-2xl font-semibold tracking-[-0.02em] text-on-surface">
                <SymbolIcon name="monitoring" className="h-6 w-6 text-primary" />
                Performance &amp; Impact
              </h2>
